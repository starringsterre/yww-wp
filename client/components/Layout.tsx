          ...
          <div className="flex justify-between items-center h-20">
            ...
            {(location.pathname !== "/" || hasScrolled) && (
              <Link to="/" className="flex-shrink-0">
                <img
                  src="https://cdn.builder.io/api/v1/image/assets%2F264b1b44affb4c70ba84c30b9a51f9df%2F7d902ac805d74bcca6b1cd2c0ed07af5?format=webp&width=4000"
              ...
              <ul className="space-y-2">
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      to={link.href}
                      className="text-sm text-black hover:text-gray-700 transition-all duration-300 hover:scale-110 inline-block origin-left"
                    >
                      {link.label}
                    </Link>
                  </li>
