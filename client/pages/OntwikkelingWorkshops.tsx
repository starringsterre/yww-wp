...
export default function OntwikkelingWorkshops() {
  const { data: cms } = usePageContent("workshops");
  ...
  // Parse newline-separated CMS list fields into arrays
  const forWhomItems: string[] = cms?.for_whom_items
    ? cms.for_whom_items.split("\n").filter((s: string) => s.trim())
    : [
        "✓ Op zoek zijn naar meer betekenis in werk en leven",
  ...
  return (
    <div className="w-full">
      <SEOHead
        title="Dag Workshops voor Jonge Vrouwen | Young Wise Women"
        description="Praktische dag workshops voor jonge professionals: female leadership, vitaliteit en mentale weerbaarheid met direct toepasbare tools."
        path="/retreats/persoonlijke-ontwikkeling-dag-workshops"
        jsonLd={{
          "@context": "https://schema.org",
          "@graph": [
            { "@type": "Event", name: "Female leadership workshop", description: "Praktische dag workshop voor jonge professional vrouwen met direct toepasbare tools.", startDate: "2026-03-20T09:30:00+01:00", endDate: "2026-03-20T17:00:00+01:00", eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode", eventStatus: "https://schema.org/EventScheduled", location: { "@type": "Place", name: "Young Wise Women Trainingslocatie", address: { "@type": "PostalAddress", addressLocality: "Castricum", addressCountry: "NL" } }, organizer: { "@type": "Organization", name: "Young Wise Women", url: "https://youngwisewomen.nl" }, offers: { "@type": "Offer", priceCurrency: "EUR", price: "245", availability: "https://schema.org/InStock", url: "https://youngwisewomen.nl/retreats/persoonlijke-ontwikkeling-dag-workshops" } },
            { "@type": "Event", name: "Workshop vitaliteit", description: "Praktische dag workshop voor jonge professional vrouwen met direct toepasbare tools.", startDate: "2026-04-10T09:30:00+02:00", endDate: "2026-04-10T17:00:00+02:00", eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode", eventStatus: "https://schema.org/EventScheduled", location: { "@type": "Place", name: "Young Wise Women Trainingslocatie", address: { "@type": "PostalAddress", addressLocality: "Castricum", addressCountry: "NL" } }, organizer: { "@type": "Organization", name: "Young Wise Women", url: "https://youngwisewomen.nl" }, offers: { "@type": "Offer", priceCurrency: "EUR", price: "215", availability: "https://schema.org/InStock", url: "https://youngwisewomen.nl/retreats/persoonlijke-ontwikkeling-dag-workshops" } },
            { "@type": "Event", name: "Workshop mentale weerbaarheid", description: "Praktische dag workshop voor jonge professional vrouwen met direct toepasbare tools.", startDate: "2026-04-24T09:30:00+02:00", endDate: "2026-04-24T17:00:00+02:00", eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode", eventStatus: "https://schema.org/EventScheduled", location: { "@type": "Place", name: "Young Wise Women Trainingslocatie", address: { "@type": "PostalAddress", addressLocality: "Castricum", addressCountry: "NL" } }, organizer: { "@type": "Organization", name: "Young Wise Women", url: "https://youngwisewomen.nl" }, offers: { "@type": "Offer", priceCurrency: "EUR", price: "225", availability: "https://schema.org/InStock", url: "https://youngwisewomen.nl/retreats/persoonlijke-ontwikkeling-dag-workshops" } },
            { "@type": "Event", name: "Workshop persoonlijke effectiviteit", description: "Praktische dag workshop voor jonge professional vrouwen met direct toepasbare tools.", startDate: "2026-05-08T09:30:00+02:00", endDate: "2026-05-08T17:00:00+02:00", eventAttendanceMode: "https://schema.org/OfflineEventAttendanceMode", eventStatus: "https://schema.org/EventScheduled", location: { "@type": "Place", name: "Young Wise Women Trainingslocatie", address: { "@type": "PostalAddress", addressLocality: "Castricum", addressCountry: "NL" } }, organizer: { "@type": "Organization", name: "Young Wise Women", url: "https://youngwisewomen.nl" }, offers: { "@type": "Offer", priceCurrency: "EUR", price: "235", availability: "https://schema.org/InStock", url: "https://youngwisewomen.nl/retreats/persoonlijke-ontwikkeling-dag-workshops" } },
          ],
        }}
      />
      <HeroSection
        ...
        subtitle={
          cms?.hero_subtitle ||
          "Praktische groepsworkshops voor jonge professionals die willen groeien in focus, energie en leiderschap."
        }
      />
